...
export function ContactSection() {
    ...
    return (
        <section className="py-20 px-4 md:px-8 bg-gradient-to-br from-white to-blue-50 dark:from-slate-950 dark:to-slate-900">
            <div className="max-w-2xl mx-auto">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <a href="mailto:wayan@example.com" className="text-blue-600 dark:text-blue-400 hover:underline">
                                    wayan@example.com
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            <svg className="w-6 h-6 text-blue-600 dark:text-blue-400 mr-4 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="mt-8 p-6 bg-blue-100 dark:bg-blue-900/30 rounded-lg">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    className="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none h-32"
                ...
                <div className="bg-blue-600 dark:bg-blue-700 rounded-lg p-8 text-center">
                    ...
                    <p className="text-blue-100 mb-6">Subscribe to my newsletter for tech insights and project updates.</p>
                    <form className="flex flex-col sm:flex-row gap-3 max-w-sm mx-auto">
                        <input
                            type="email"
                            placeholder="your@email.com"
                            className="flex-1 px-4 py-2 rounded-lg bg-white/90 dark:bg-slate-800 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-300"
                            required
                        />
                        <Button variant="outline" size="md" className="bg-white text-blue-600 hover:bg-blue-50 border-0">
                            Subscribe
                        </Button>
                    </form>
                </div>
